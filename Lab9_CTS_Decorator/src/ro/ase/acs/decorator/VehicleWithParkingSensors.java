...
public class VehicleWithParkingSensors extends VehicleDecorator{
    ...
    public  void  start(){
        super.start();
        System.out.println(String.format("%d sensors have been activates!",noOfSensors));
    }

    @Override
    public  void  stop(){
        super.stop();
        System.out.println(String.format("%d sensors have been deactivates!", noOfSensors));
    }
