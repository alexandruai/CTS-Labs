...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Vehicle carWithAlarmAndParkingSensors = new VehicleWithParkingSensors(
                new VehicleWithAlarm(car), 3);
        carWithAlarmAndParkingSensors.start();
        carWithAlarmAndParkingSensors.stop();

        //Clasa anonima, instanta
        //Alata varianta, nu e acceptata la examen
